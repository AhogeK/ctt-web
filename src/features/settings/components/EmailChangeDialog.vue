      ...
      <form @submit="onSubmit" class="flex flex-col gap-4">
        <div class="flex flex-col gap-2">
          ...
          <Input
            ...
            "
            v-bind="form.defineField('email')[0]"
          />
          <p v-if="form.errors.value.email" class="text-sm text-destructive">
            {{ form.errors.value.email }}
          </p>
        </div>

        <div v-if="showPasswordField" class="flex flex-col gap-2">
          <Label
          ...
          <Input
            ...
            "
            v-bind="form.defineField('password')[0]"
          />
          <p v-if="form.errors.value.password" class="text-sm text-destructive">
