...
import type { TrophyArt } from '../composables/trophy-model'
...
<template>
  <svg
    ...
    aria-hidden="true"
  >
    <!-- Completing a ladder earns a ring, the one decoration rank may add. -->
    <circle v-if="maxed" cx="12" cy="12" r="11" :stroke="BRAND" stroke-width="1" fill="none" opacity="0.6" />
