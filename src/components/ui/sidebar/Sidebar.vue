...
<template>
  <div
    ...
    data-slot="sidebar"
    :class="['bg-sidebar text-sidebar-foreground flex h-full w-(--sidebar-width) flex-col', props.class]"
    v-bind="$attrs"
  >
    <slot />
  </div>
    ...
    <div
      :class="[
        ...
        variant === 'floating' || variant === 'inset'
          ...
          : 'group-data-[collapsible=icon]:w-(--sidebar-width-icon)',
        variant !== 'floating' && variant !== 'inset' && 'group-data-[side=left]:border-r',
        variant !== 'floating' && variant !== 'inset' && 'group-data-[side=right]:border-l',
        props.class,
      ]"
      v-bind="$attrs"
    >
