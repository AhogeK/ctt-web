...
- Snapshot (2026-09-20, after `vp update -L`): @lucide/vue 1.47.0, zod 4.6.5, @types/node 26.6.2, eslint-plugin-oxlint 1.83.0, lint-staged 17.5.1, **vite-plus + vite 0.3.3**, vue-tsc 3.3.11, @playwright/test 1.63.0, jsdom 30.1.0, vue-i18n 11.4.12, **@vueuse/core 15.0.0**. Two pins are re-applied after every `vp update -L`:
